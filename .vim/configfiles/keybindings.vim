...
" Abre una terminal a en vertical
nnoremap <silent><leader>t :rightbelow vertical terminal ++close<CR>
...
" Lista de snippets
nnoremap <silent><leader>cl :CocList snippets<CR>
inoremap <silent><expr> <c-space> coc#refresh()

" Usar Tab para siguiente y Shift+Tab para anterior
let g:coc_snippet_next = '<tab>'
let g:coc_snippet_prev = '<s-tab>'

" Configuración avanzada: Tab para completar, expandir Y saltar
